...
--               f:/vivado/cpu/MCCPUALLORI_SOC/MCCPUALLORI_SOC.srcs/sources_1/ip/dmem/dmem_sim_netlist.vhdl
-- Design      : dmem
...
entity dmem_dpram is
  ...
  attribute ORIG_REF_NAME of dmem_dpram : entity is "dpram";
end dmem_dpram;

architecture STRUCTURE of dmem_dpram is
...
ram_reg_0_127_0_0: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"000000000000012998011E8024802040"
    )
        port map (
...
ram_reg_0_127_3_3: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"0000000000000040190B1F884B044049"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(3),
...
ram_reg_0_127_6_6: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"0000000000000100000102E440000000"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(6),
...
begin
\gen_dp_ram.dpram_inst\: entity work.dmem_dpram
     port map (
      a(6 downto 0) => a(6 downto 0),
      clk => clk,
...
entity dmem_dist_mem_gen_v8_0_12 is
  ...
  attribute C_HAS_DPO of dmem_dist_mem_gen_v8_0_12 : entity is 1;
  attribute C_HAS_DPRA : integer;
  attribute C_HAS_DPRA of dmem_dist_mem_gen_v8_0_12 : entity is 1;
  ...
  attribute C_MEM_TYPE of dmem_dist_mem_gen_v8_0_12 : entity is 2;
